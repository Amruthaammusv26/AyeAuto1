 ...
 if(request.getParameter("button2")!=null)
{
     ...
     st.executeUpdate("update notification_tb set notification='"+notification+"' where nid='"+id+"'");
      response.sendRedirect("notificationview.jsp");
}
 ResultSet rs=st.executeQuery("select * from notification_tb where nid='"+id+"'");
     if(rs.next())
     {
%>
...
<form id="form1" name="form1" method="post">
  ...
  <table width="579" border="0" align="center" cellpadding="0">
    <tr>
      ...
      <textarea name="textarea" id="textarea" cols="45" rows="5"> <%=rs.getString(2)%> </textarea></td>
    </tr>
          <%
     }
          %>
